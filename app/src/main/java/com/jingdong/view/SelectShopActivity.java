...
import com.jingdong.adapter.LiShiSouSuoAdapter;
import com.jingdong.adapter.ReSouAdapter;
import com.jingdong.app.MyApp;
import com.jingdong.bean.SelectGreenDaoBean;
import com.jingdong.greendao.DaoSession;
import com.jingdong.greendao.SelectGreenDaoBeanDao;
...
public class SelectShopActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initData() {
        ...
        ReSouAdapter reSouAdapter = new ReSouAdapter(SelectShopActivity.this, horizontallist);

        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(SelectShopActivity.this, LinearLayoutManager.HORIZONTAL, false);

        mResou.setLayoutManager(linearLayoutManager);

        mResou.setAdapter(reSouAdapter);

        liShiSouSuoAdapter = new LiShiSouSuoAdapter(SelectShopActivity.this, strlist);

        LinearLayoutManager tManager = new LinearLayoutManager(SelectShopActivity.this, LinearLayoutManager.VERTICAL, true);
        ...
        switch (v.getId()) {
            ...
            case R.id.ssbutton:
                ...
                if (itemGoods.isEmpty()) {
                    Toast.makeText(SelectShopActivity.this, "亲,没有搜索的东东呢!!!", Toast.LENGTH_SHORT).show();
                    return;
                }
                //保存搜索历史到数据库
                ...
                Intent intent = new Intent(SelectShopActivity.this,InfoDetailsActivity.class);
